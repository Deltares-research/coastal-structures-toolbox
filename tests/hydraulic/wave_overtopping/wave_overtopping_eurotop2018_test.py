...
@pytest.mark.parametrize(
    ...
    (
        ([2.0, 5.00, 0.0, 3.0, 3.0, 1.0e-3, 0.0, 0.0, 1.0, 1.0, 4.90]),
        ([2.5, 5.00, 0.0, 3.0, 3.0, 1.0e-3, 0.0, 0.0, 1.0, 1.0, 5.62]),
        ([2.0, 7.00, 0.0, 3.0, 3.0, 1.0e-3, 0.0, 0.0, 1.0, 1.0, 6.49]),
        ([2.0, 5.00, 30.0, 3.0, 3.0, 1.0e-3, 0.0, 0.0, 1.0, 1.0, 4.41]),
        ([2.0, 5.00, 0.0, 3.5, 3.0, 1.0e-3, 0.0, 0.0, 1.0, 1.0, 4.59]),
        ([2.0, 5.00, 0.0, 3.0, 2.0, 1.0e-3, 0.0, 0.0, 1.0, 1.0, 6.46]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 1.0e-2, 0.0, 0.0, 1.0, 1.0, 3.47]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 1.0e-3, 1.0, 1.0, 1.0, 1.0, 4.54]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 1.0e-3, 2.0, 1.0, 1.0, 1.0, 4.23]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 1.0e-3, 1.0, 0.8, 1.0, 1.0, 4.52]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 1.0e-3, 0.0, 0.0, 0.45, 1.0, 2.20]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 1.0e-3, 0.0, 0.0, 1.0, 0.8, 3.92]),
        ([2.0, 5.00, 0.0, 3.5, 3.0, 1.0e-3, 2.0, 1.0, 1.0, 1.0, 4.08]),
        ([2.0, 5.00, 0.0, 3.0, 2.0, 1.0e-3, 2.0, 1.0, 1.0, 1.0, 5.67]),
        ([2.0, 5.00, 30.0, 3.0, 3.0, 1.0e-3, 0.0, 0.0, 0.45, 1.0, 1.79]),
    ),
)
