...
@pytest.mark.parametrize(
    ...
    (
        ...
        ([2.0, 0.01, 0.5, 0.55, 0.5, 1.31269112]),
        ([2.5, 0.01, 0.5, 0.55, 0.5, 1.84624763]),
        ([2.0, 0.02, 0.5, 0.55, 0.5, 1.08595]),
        ([2.5, 0.02, 0.5, 0.55, 0.5, 1.51933256]),
        ...
        ([2.0, 0.01, 0.7, 0.55, 0.5, 1.35469112]),
        ([2.5, 0.01, 0.7, 0.55, 0.5, 1.88824763]),
        ([2.0, 0.02, 0.7, 0.55, 0.5, 1.12795]),
        ([2.5, 0.02, 0.7, 0.55, 0.5, 1.56133256]),
    ),
)
