...
@pytest.mark.parametrize(
    ...
    (
        ...
        ([2.0, 5.00, 0.0, 3.0, 3.0, 5.0, 0.0, 0.0, 0.45]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 5.0, 0.0, 0.0, 1.0]),
        ([2.0, 5.00, 0.0, 3.5, 3.0, 5.0, 2.0, 1.0, 1.0]),
        ([2.0, 5.00, 0.0, 3.0, 2.0, 5.0, 2.0, 1.0, 1.0]),
        ([2.0, 5.00, 30.0, 3.0, 3.0, 5.0, 0.0, 0.0, 0.45]),
    ),
)
...
@pytest.mark.parametrize(
    ...
    (
        ([2.0, 5.00, 0.0, 3.0, 3.0, 5.0, 0.0, 0.0, 1.0, 5.639]),
        ([2.5, 5.00, 0.0, 3.0, 3.0, 5.0, 0.0, 0.0, 1.0, 24.890]),
        ([2.0, 7.00, 0.0, 3.0, 3.0, 5.0, 0.0, 0.0, 1.0, 5.639]),
        ([2.0, 5.00, 30.0, 3.0, 3.0, 5.0, 0.0, 0.0, 1.0, 3.756]),
        ([2.0, 5.00, 0.0, 3.5, 3.0, 5.0, 0.0, 0.0, 1.0, 5.639]),
        ([2.0, 5.00, 0.0, 3.0, 2.0, 5.0, 0.0, 0.0, 1.0, 5.639]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 4.5, 0.0, 0.0, 1.0, 10.022]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 5.0, 1.0, 1.0, 1.0, 5.639]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 5.0, 2.0, 1.0, 1.0, 5.639]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 5.0, 1.0, 0.8, 1.0, 5.639]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 5.0, 0.0, 0.0, 0.45, 0.0050]),
        ([2.0, 5.00, 0.0, 3.5, 3.0, 5.0, 2.0, 1.0, 1.0, 5.639]),
        ([2.0, 5.00, 0.0, 3.0, 2.0, 5.0, 2.0, 1.0, 1.0, 5.639]),
        ([2.0, 5.00, 30.0, 3.0, 3.0, 5.0, 0.0, 0.0, 0.45, 0.0020]),
    ),
)
def test_q_backward(
    Hm0,
...
@pytest.mark.parametrize(
    ...
    (
        ([2.0, 5.00, 0.0, 3.0, 3.0, 1.0e-3, 0.0, 0.0, 1.0, 6.50]),
        ([2.5, 5.00, 0.0, 3.0, 3.0, 1.0e-3, 0.0, 0.0, 1.0, 8.49]),
        ([2.0, 7.00, 0.0, 3.0, 3.0, 1.0e-3, 0.0, 0.0, 1.0, 6.50]),
        ([2.0, 5.00, 30.0, 3.0, 3.0, 1.0e-3, 0.0, 0.0, 1.0, 6.07]),
        ([2.0, 5.00, 0.0, 3.5, 3.0, 1.0e-3, 0.0, 0.0, 1.0, 6.50]),
        ([2.0, 5.00, 0.0, 3.0, 2.0, 1.0e-3, 0.0, 0.0, 1.0, 6.50]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 1.0e-2, 0.0, 0.0, 1.0, 4.50]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 1.0e-3, 1.0, 1.0, 1.0, 6.50]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 1.0e-3, 2.0, 1.0, 1.0, 6.50]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 1.0e-3, 1.0, 0.8, 1.0, 6.50]),
        ([2.0, 5.00, 0.0, 3.0, 3.0, 1.0e-3, 0.0, 0.0, 0.45, 2.93]),
        ([2.0, 5.00, 0.0, 3.5, 3.0, 1.0e-3, 2.0, 1.0, 1.0, 6.50]),
        ([2.0, 5.00, 0.0, 3.0, 2.0, 1.0e-3, 2.0, 1.0, 1.0, 6.50]),
        ([2.0, 5.00, 30.0, 3.0, 3.0, 1.0e-3, 0.0, 0.0, 0.45, 2.73]),
    ),
)
