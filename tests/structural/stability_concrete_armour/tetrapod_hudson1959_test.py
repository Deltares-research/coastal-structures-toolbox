...
import deltares_coastal_structures_toolbox.functions.structural.stability_concrete_armour.tetrapod_hudson1959 as tetrapods
...
def test_M_nodamage_backward(
    ...
    M_calculated = tetrapods.calculate_unit_mass_M(
        Hs=Hs,
        rho_water=rho_water,
...
def test_M_nodamage_backward(
    ...
    Hs_calculated = tetrapods.calculate_significant_wave_height_Hs(
        M=M,
        rho_water=rho_water,
        rho_armour=rho_armour,
        KD=KD,
