...
@pytest.mark.parametrize(
    ...
    (
        ...
        ([8.0, 2650, 3000, 10.0, 2.0, 2.0, 0.626]),
...
@pytest.mark.parametrize(
    ("cot_alpha, rho_armour, N_waves, Tmm10, S, M50, Hs_expected"),
    (
        ([8.0, 2650, 3000, 6.0, 2.0, 150.0, 2.14]),
        ([7.0, 2650, 3000, 6.0, 2.0, 150.0, 1.59]),
        ([8.0, 2850, 3000, 6.0, 2.0, 150.0, 2.62]),
        ([8.0, 2650, 6000, 6.0, 2.0, 150.0, 1.85]),
        ([8.0, 2650, 3000, 8.0, 2.0, 150.0, 1.18]),
        ([8.0, 2650, 3000, 6.0, 3.0, 150.0, 2.56]),
        ([8.0, 2650, 3000, 6.0, 2.0, 100.0, 1.60]),
    ),
)
...
@pytest.mark.parametrize(
    ("cot_alpha, rho_armour, N_waves, Tmm10, Hs, M50"),
    (
        ([8.0, 2650, 3000, 6.0, 2.0, 150.0]),
        ([7.0, 2650, 3000, 6.0, 2.0, 150.0]),
        ([8.0, 2850, 3000, 6.0, 2.0, 150.0]),
        ([8.0, 2650, 6000, 6.0, 2.0, 150.0]),
        ([8.0, 2650, 3000, 10.0, 2.0, 150.0]),
        ([8.0, 2650, 3000, 6.0, 2.5, 150.0]),
        ([8.0, 2650, 3000, 6.0, 2.0, 100.0]),
    ),
)
