...
@pytest.mark.parametrize(
    ...
    (
        ([3.0, 0.4, 2650, 3000, 6.0, 2.0, 1000.0, 0.918]),  # failing
        ([2.0, 0.4, 2650, 3000, 6.0, 2.0, 1000.0, 2.53]),  # failing
        ([3.0, 0.5, 2650, 3000, 6.0, 2.0, 1000.0, 0.751]),
        ([3.0, 0.4, 2850, 3000, 6.0, 2.0, 1000.0, 0.580]),
        ([3.0, 0.4, 2650, 6000, 6.0, 2.0, 1000.0, 1.30]),  # failing
        ([3.0, 0.4, 2650, 3000, 12.0, 2.0, 1000.0, 2.51]),
        ([3.0, 0.4, 2650, 3000, 6.0, 2.5, 1000.0, 2.12]),  # failing
        ([3.0, 0.4, 2650, 3000, 6.0, 2.0, 1200.0, 0.677]),
        ([3.6, 0.4, 2650, 3000, 12.0, 2.0, 1200.0, 3.29]),  # failing
    ),
)
def test_S_backward(
    cot_alpha,
...
@pytest.mark.parametrize(
    ...
    (
        ...
        ([3.6, 0.4, 2650, 3000, 12.0, 2.0, 2.0, 0.798]),
    ),
)
